...
$app -> get('/admin/catalogos/gestor-catalogos/', function() use ($app) {
	...
	$titulacion=FormaTitulacion::all();
	$elementos=array_merge($idiomas,$lineas,$lenguajes,$plataformas,$areas,$formas,$herramientas,$carreras,$titulacion);
...
$app->get('/admin/catalogos/gestor-catalogos-eliminar/:id/:tipo/', function($id,$tipo) use($app){
		$arr = array(
			...
			"Lenguaje" => array("UsuariosLenguajes","find_by_lenguaje_id"),
			"Idioma" => array("UsuariosIdiomas","find_by_idioma_id"),
			"Plataforma" => array("UsuariosPlataformas","find_by_plataforma_id"),
			"AreaInteres" => array("UsuariosAreas","find_by_area_id"),
			"LineaInvestigacion" => array("Posgrado","find_by_linea_investigacion"),
