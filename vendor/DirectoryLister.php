...
class DirectoryLister {
    ...
    public function __construct() {    
        ...
        if (file_exists($configFile)) {
            ...
            $this->setSystemMessage('error', '<b>ERROR:</b> Unable to locate application config file '.$configFile);
        }
        // Set the theme name
        $this->_themeName = $this->_config['theme_name'];
        // Set the directory global variable
        $this->_directory = $this->_setDirectoryPath(@$_GET['dir']);
    }
                ...
                if ($file == '..') {
                    if ($this->_directory != '.') {
                        ...
                        if (!empty($directoryPath)) {
                            ...
                            $directoryPath = urlencode($directoryPath);
                        }
