...
function replace_hashes($content){
	$app = Slim::getInstance();
	$hashes = array(
		"@antecedentes",
		"@mision-y-vision",
...
//		"@horarios",
	...
	$urls   = array(
		...
		'<a href="'.$app->urlFor('home', array('slug' => 'mision-y-vision')).'" >Misión y Visión</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'objetivos')).'" >Objetivos</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'logros-y-reconocimientos')).'" >Logros y Reconocimientos</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'lineas-de-generacion-y-aplicacion-de-conocimiento')).'" >Líneas de Generación y Aplicación de Conocimiento</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'vinculacion')).'" >Vinculación</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'proceso-de-admision')).'" >Proceso de Admisión</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'perfil-de-ingreso')).'" >Perfil de Ingreso</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'perfil-de-egreso')).'" >Perfil de Egreso</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'curso-propedeutico')).'" >Curso Propedéutico</a>',
		'<a href="'.$app->urlFor('home', array('slug' => 'material-de-apoyo')).'" >Material de Apoyo</a>',
		'<a href="'.$app->urlFor('relacion-aceptados').'" >Relación de Aceptados</a>',
		'<a href="'.$app->urlFor('plan-estudios').'" >Estructura del Plan de Estudios</a>',
//		'<a href="'.$app->urlFor('horarios').'" >Horarios</a>',
		...
		'<a href="'.$app->urlFor('registro-inicio').'" >Registro Aspirantes</a>',
	);
